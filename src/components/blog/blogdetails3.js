...
const BlogDetails3 = () =>{
    return(
        <>
        <Header />
        <section className='blogdetails1-container'>
            <div className='blogdetails1-container-main'>
                <h1>Why employer healthcare strategies must be local three</h1>
                <p className='blogdetails1-container-main-para'>The best employers care not only about their employees’ productivity, but their well-being. And if you’re heading up a large company that employs people in various markets, you may be familiar with a common conundrum: health care is fundamentally local.</p>
                <div className='blogdetails1-container-main-date'>
                    <div className='blog-detail-date d-flex'>
